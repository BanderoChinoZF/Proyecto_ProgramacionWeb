        ...
        <div class="tile-body nopadding">        
          ...
          <section class="tile">
                  ...
                  <div class="tile-body">
                    ...
                    <form name="registroUsuarios" id="registroUsuarios" method="POST" action="<?php echo base_url();?>/Acceso/guardarNuevaContra/" onsubmit="return _validar_cambio_contrasenia();">

                  <div class="row">
                    <div class="form-group col-sm-3">
                        <label for="antiguaContra"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Contrseña Anterior: </font></font></label>
                        <input type="text" 
                          class="form-control" 
                          id="antiguaContra" 
                          name="antiguaContra" 
                          placeholder="Ingresa Tu Anterior Contraseña"
                          autocomplete="off"
                          required>
                      </div>
                      <div class="form-group col-sm-3">
                        <label for="contraNueva1"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nueva Contraeña: </font></font></label>
                        <input type="password" 
                          class="form-control" 
                          id="contraNueva1" 
                          name="contraNueva1" 
                      ...
                      <div class="form-group col-sm-3">
                        <label for="contraNueva2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Repite la Nueva Contraeña: </font></font></label>
                        <input type="password" 
                          class="form-control" 
                          id="contraNueva2" 
                          name="contraNueva2" 
                          placeholder="Ingrese Otra Vez La Nueva Contraseña:"
                          autocomplete="off"
                          required>
                      </div>
